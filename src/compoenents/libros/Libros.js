                    ...
                    <tbody>
                        {libros.map(libro => (
                            <tr key={libro.id}>
                                ...
                                <td>
                                    <Link to={`/libros/mostrar/${libro.id}`} className="btn btn-success btn-blcok"> 
                                        <i className="fas fa-angle-double-rigth"></i> {' '} 
                                        Más Info
                                    </Link>
                                    <button type="button" className="btn btn-danger btn-blcok ml-1"
                                        onClick={() => _eliminarLibro(libro.id)}
                                    >
